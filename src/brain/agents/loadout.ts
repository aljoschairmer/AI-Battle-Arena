...
export class LoadoutAgent extends Agent<LoadoutAgentInput, LoadoutOutput> {
  ...
  protected systemPrompt(): string {
    return [
      ...
      "{sword, shield, spear}. The only exception: our_weapon_history shows a weapon in YOUR archetype set",
      "at 0 wins over 3+ recent rounds — then take the best remaining weapon from your set, or if the whole",
      "set is proven losing, fall back to the overall best. A weapon with real wins in our_weapon_history is",
      "always fair game for your slot. Index 1 and 2 must NEVER copy index 0's likely pick.",
      "",
