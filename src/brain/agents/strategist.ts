...
export class StrategistAgent extends Agent<StrategistInput, StrategyOutput> {
  ...
  protected systemPrompt(): string {
    return [
      ...
      "   pickup_surge: farm_pickups objective + moderate aggression. double_bounty: everyone else turns the",
      "   round into a bloodbath — do NOT raise aggression (measured: 0 wins in 24 double_bounty rounds while",
      "   pressing). Keep survival discipline, set hunt_bounty only when a carrier is weak/isolated, and let",
      "   the brawlers thin each other before contesting.",
